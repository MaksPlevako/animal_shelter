		...
		<section className='my-6'>
			...
			<div className='lg:flex lg:flex-row lg:w-full lg:justify-around lg:mx-auto lg:items-center lg:gap-6'>
				<div className='w-full my-6 relative lg:w-2/5'>
					<img src={dog2} alt='dog2' className='relative mx-auto lg:w-[170%]' />
					<img
						src={decor2}
						alt='decor2'
				...
				<div className='lg:w-2/5'>
					<div className='w-11/12 mx-auto text-[#404242] mb-6 lg:w-full lg:text-2xl'>
						...
						<p className={about ? 'block' : 'hidden'}>
							...
							собак, щоб уникнути спалаху захворювань. Наша робота вимагає дуже
							багато зусиль, як фізичних, так і фінансових. Допомога від міста
							полягає тільки у стерилізації та кастрації тварин, а всі інші
							витрати, включно із зарплатою, оплатою комунальних послуг,
							ремонтними роботами та лікуванням хворих тварин - це все на руках
							волонтерів та благодійних коштах. Ми щиро сподіваємося, що наша
							праця не марна і нас підтримають люди по всьому світу!
						</p>
					</div>
